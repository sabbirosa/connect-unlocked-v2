...
// MultiSelect wrapper component for easier usage
...
const MultiSelect = ({ values, onValuesChange, options, placeholder = "Select options...", className }: MultiSelectProps) => {
  return (
    <MultiSelector values={values} onValuesChange={onValuesChange} className={className}>
      <MultiSelectorTrigger placeholder={placeholder}>
